...
// Inicialização do sistema da Paula Dantas
document.addEventListener('DOMContentLoaded', function() {
  // Aguarda um pouco para garantir que todos os scripts foram carregados
  setTimeout(function() {
    if (typeof initUtmTracking === 'function') {
      console.log('🎗️ [Paula] Inicializando sistema de rastreamento UTM para Paula Dantas...');
      initUtmTracking();
    } else {
      console.warn('⚠️ [Paula] Função initUtmTracking não encontrada');
    }
  }, 1000);
});
